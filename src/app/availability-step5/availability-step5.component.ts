...
@Component({
  selector: 'app-availability-step5',
  templateUrl: './availability-step5.component.html',
  styleUrl: './availability-step5.component.css'
})
export class AvailabilityStep5Component {
  steps: StepItem[] = [
    {

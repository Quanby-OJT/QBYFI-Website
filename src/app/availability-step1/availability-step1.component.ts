...
@Component({
  selector: 'app-availability-step1',
  templateUrl: './availability-step1.component.html',
  styleUrl: './availability-step1.component.css'
})

export class AvailabilityStep1Component {
  steps: StepItem[] = [
    {

...
@Component({
  selector: 'app-availability-step4',
  templateUrl: './availability-step4.component.html',
  styleUrl: './availability-step4.component.css'
})

export class AvailabilityStep4Component {
  steps: StepItem[] = [
    {

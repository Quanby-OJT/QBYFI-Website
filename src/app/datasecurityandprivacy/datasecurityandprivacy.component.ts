...
@Component({
  selector: 'app-datasecurityandprivacy',
  templateUrl: './datasecurityandprivacy.component.html',
  styleUrl: './datasecurityandprivacy.component.css'
})
export class DatasecurityandprivacyComponent {
  searchQuery: string = '';
  isLoading = false;

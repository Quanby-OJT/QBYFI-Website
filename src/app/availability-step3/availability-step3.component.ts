...
@Component({
  selector: 'app-availability-step3',
  templateUrl: './availability-step3.component.html',
  styleUrl: './availability-step3.component.css'
})
export class AvailabilityStep3Component {
  steps: StepItem[] = [
    {

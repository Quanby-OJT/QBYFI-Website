...
@Component({
  selector: 'app-networkinsfastructure',
  templateUrl: './networkinfastructure.component.html',
  styleUrl: './networkinfastructure.component.css'
})
export class NetworkinfastructureComponent {
  searchQuery: string = '';
  isLoading = false;
